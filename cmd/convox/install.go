...
func cmdInstall(c *cli.Context) {
	...
	req := &cloudformation.CreateStackInput{
		...
		Parameters: []*cloudformation.Parameter{
			...
			&cloudformation.Parameter{ParameterKey: aws.String("Subnet0CIDR"), ParameterValue: aws.String(subnetParams[0])},
			&cloudformation.Parameter{ParameterKey: aws.String("Subnet1CIDR"), ParameterValue: aws.String(subnetParams[1])},
			&cloudformation.Parameter{ParameterKey: aws.String("Subnet2CIDR"), ParameterValue: aws.String(subnetParams[2])},
